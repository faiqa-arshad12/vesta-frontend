      ...
      <div className="bg-primary px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex items-center justify-between rounded-b-xl">
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48 sm:w-56 cursor-pointer">
              <DropdownMenuItem className="w-48 sm:w-56 cursor-pointer hover:bg-white/10">Log out</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
